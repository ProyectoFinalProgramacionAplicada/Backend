        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CostTrueCoins = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TrueCoinBalance = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Title = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    TrueCoinValue = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    ImageUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Address = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Lat = table.Column<double>(type: "float", nullable: true),
                    Lng = table.Column<double>(type: "float", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OwnerUserId = table.Column<int>(type: "int", nullable: false),
                    TargetListingId = table.Column<int>(type: "int", nullable: false),
                    OfferedListingId = table.Column<int>(type: "int", nullable: true),
                    Status = table.Column<int>(type: "int", nullable: false),
                    Message = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ExchangeAddress = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ExchangeLat = table.Column<double>(type: "float", nullable: true),
                    ExchangeLng = table.Column<double>(type: "float", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Trades_Listings_OfferedListingId",
                        column: x => x.OfferedListingId,
                        principalTable: "Listings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Trades_Listings_TargetListingId",
                        column: x => x.TargetListingId,
                        principalTable: "Listings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Trades_Users_OwnerUserId",
                        column: x => x.OwnerUserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Trades_Users_RequesterUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TradeMessages_Users_SenderUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserReviews_Trades_TradeId",
                        column: x => x.TradeId,
                        principalTable: "Trades",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserReviews_Users_FromUserId",
                        column: x => x.FromUserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UserReviews_Users_ToUserId",
                        column: x => x.ToUserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TradeMessages_SenderUserId",
                table: "TradeMessages",
                column: "SenderUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Trades_OfferedListingId",
                table: "Trades",
                column: "OfferedListingId");

            migrationBuilder.CreateIndex(
                name: "IX_Trades_OwnerUserId",
                table: "Trades",
                column: "OwnerUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Trades_RequesterUserId",
                table: "Trades",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Trades_TargetListingId",
                table: "Trades",
                column: "TargetListingId");

            migrationBuilder.CreateIndex(
                name: "IX_UserReviews_FromUserId",
                table: "UserReviews",
                column: "FromUserId");

            migrationBuilder.CreateIndex(
                name: "IX_UserReviews_ToUserId",
                table: "UserReviews",
                column: "ToUserId");

            migrationBuilder.CreateIndex(
                name: "IX_UserReviews_TradeId",
                table: "UserReviews",
                column: "TradeId");
